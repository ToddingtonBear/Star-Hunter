...
public:
    ...
    Player(float x, float y, SpriteType type, AnimationType animType, float spd, int hp,
    ...
    void SetState(PlayerState newState); // Update the player's state and animation
};